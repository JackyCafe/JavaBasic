...
// 空白行, 跳過該筆資料！
            ...
            String air_cond = carInfo[2];
            switch (model) {
                case 'B': wh.addCar(new BasicCar(cc,air_cond )); break;
                case 'L': wh.addCar(new LuxCar(cc,air_cond )); break;
                case 'S': wh.addCar(new SuperLuxCar(cc,air_cond )); break;
            }
        }
